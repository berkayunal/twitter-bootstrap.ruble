...
END
  ...
  bundle.menu 'Twitter Bootstrap' do |menu|
    ...
    menu.menu 'Form' do |sub_menu|
        ...
        sub_menu.separator
        sub_menu.command'AppendedCheckbox'
        sub_menu.command'DisabledInput'
        sub_menu.command'DisabledTextarea'
        sub_menu.command'FileInput'
        sub_menu.command'Help'
        sub_menu.command'InlineInputs'
        sub_menu.command'Input'
        sub_menu.command'ListOfOptionsCheckbox'
        sub_menu.command'ListOfOptionsRadio'
        sub_menu.command'MultiSelect'
        sub_menu.command'PrependedCheckbox'
        sub_menu.command'PrependedText'
        sub_menu.command'Select'
        sub_menu.command'Textarea'
        sub_menu.command'UneditableInput'
